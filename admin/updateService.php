...
<body>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 col-md-10 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <form class="row g-3 needs-validation" validate action="../controller/updateService.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3" id="nombreServicio" >
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nombreServicio" type="text" class="form-control" id="nombreServicio" value="<?=$servicio["servicio_nombre"]?>" require>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="descripción" class="form-control" id="descripción"
                          style="height: 100px" required><?=$servicio["servicio_descripcion"]?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="emailContacto" type="email" class="form-control" id="emailContacto" value="<?=$servicio["servicio_email"]?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="sitioWeb" type="url" class="form-control" id="sitioWeb" placeholder="https://www.SitioWeb.com" value="<?=$servicio["servicio_web"]?>">
                      </div>
                    </div>
                    <input type="hidden" name="idRedSocial" value="<?= ($servicio["idRedSocial"]!=null)?$servicio["idRedSocial"] : ''?>">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        placeholder="https://facebook.com/#" value="<?=  ($servicio["redSocial_Facebook"]=='--' || $servicio["redSocial_Facebook"]==null || $servicio["redSocial_Facebook"]=='null')? '' : $servicio["redSocial_Facebook"]?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        placeholder="https://instagram.com/#" value="<?=  ($servicio["redSocial_Instagram"]=='--' || $servicio["redSocial_Instagram"]==null || $servicio["redSocial_Instagram"] =='null')? '' : $servicio["redSocial_Instagram"]?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        placeholder="https://linkedin.com/#" value="<?=  ($servicio["redSocial_LinkedIn"]=='--' || $servicio["redSocial_LinkedIn"]==null || $servicio["redSocial_LinkedIn"]=='null')? '' : $servicio["redSocial_LinkedIn"]?>">
                      </div>
                    </div>
  ...
  <p id="categorias-seleccionadas" class="col-12 mt-3">Categorias Seleccionadas: </p>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input type="hidden" name="idTipoServicio" value="<?=(isset($tipoServicio["tipo"]))? $tipoServicio["idTipo"] : '0'?>">
                        <select name="tipo" id="tipo" class="form-select" aria-label="Default select example" required>
                          ...
                          <option <?= (isset($tipoServicio["tipo"]) && $tipoServicio["tipo"] == "Cama adentro") ? 'selected' : '' ?> value="Cama adentro">Cama adentro</option>
                          <option <?= (isset($tipoServicio["tipo"]) && $tipoServicio["tipo"] == "Freelance") ? 'selected' : '' ?> value="Freelance">Freelance</option>
                          <option <?= (isset($tipoServicio["tipo"]) && $tipoServicio["tipo"] == "Full-time") ? 'selected' : '' ?> value="Full-time">Full-time</option>
                          <option <?= (isset($tipoServicio["tipo"]) && $tipoServicio["tipo"] == "Part-time") ? 'selected' : '' ?> value="Part-time">Part-time</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select name="provincia" id="provincia" class="form-select" aria-label="Default select example" required>
                          <option value = "">Abre este menú de selección</option>
                          <?php  
                            $isSelectedProvincia = false;
                            $idDepartamentoSelected = null;
                            while($row=mysqli_fetch_array($provincias)) {
                              if($row['idProvincia'] == $servicio["FK_idProvincia"]){
                                echo '<option id="optionProvincia" value="'.$row['idProvincia'].'" selected>'.$row['provincia_name'].'</option>';
                                echo '<input type="hidden" id="FK_idDepartamento" value="'.$servicio["FK_idDepartamento"].'">';
                                $isSelectedProvincia = true;
                                
                              }else{
                                echo '<option id="optionProvincia" value="'.$row['idProvincia'].'">'.$row['provincia_name'].'</option>';
                              }
                            }
  ...
  <?= ($isSelectedProvincia)?'<script> getProvincia(); </script>' : ''?>
  <script src="../assets/js/galeriaImg.js"></script>
  <script src="../assets/js/horarios.js"></script>
  <script src="../assets/js/main.js"></script>  
  <script src="../assets/js/setHorarios.js"></script>  
...
function populateCategories(cats) {
  ...
  // Keep the "Solicitar Categoria" item
  const staticItems = categoryList.innerHTML;
  categoryList.innerHTML = staticItems;
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('.././controller/solicitarCategoria.php', {
        ...
        body: `categoria=${encodeURIComponent(result.value)}&email=${encodeURIComponent('<?= $servicio["user_email"] ?>')}&usuario=${encodeURIComponent('<?= $servicio['user_login'] ?>')}`
      })
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  await fetch('.././controller/api/getCategoriesByServiceId.php', {
    ...
    .then(data => {
      selectedCategories = data.map(category => category.FK_idCategoria);
    });
