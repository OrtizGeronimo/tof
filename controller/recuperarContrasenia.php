    ...
    if(mysqli_num_rows($user) == 1){
        ...
        if($setForgotPassword){
            ...
            try{
                ...
                $mail->Username = 'administracion@todooficio.com';
                $mail->Password = 'rbquksvciayldswl';
                ...
                $mail->Body = "<html>
                                ...
                                <p>Hola ".$user["user_nombre"]."! <br><br>
                                    Recibimos una solicitud de recupero de contraseña. <br><br>
                                    Hace click aca para <b><a href='https://www.todooficio.com/reestablecerContrasenia.php?d=$forgotPasswordMd5'> Recuperar Contraseña </a></b> <br><br> 
